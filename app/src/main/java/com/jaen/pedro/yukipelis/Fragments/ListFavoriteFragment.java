...
import com.jaen.pedro.yukipelis.ViewModel.FavoriteViewModel;
...
public class ListFavoriteFragment extends Fragment {
    ...
    public void fillFragment(){//solo se usa para favoritos
        ...
        model.getListaPelis().observe(this, new Observer<List<Movie>>() {
            @Override
